...
export default function IndexReview() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-[95vw] md:max-w-[90vw] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="space-y-6 md:space-y-8">
          <div className="relative pt-2 pb-6 md:pb-8 flex flex-col h-full max-w-7xl mx-auto justify-center px-4 md:px-6">
            <h1 className="text-black font-bold text-3xl md:text-5xl lg:text-7xl max-w-2xl mb-2 md:mb-0 leading-tight text-center">
              Testimoni &{" "}
