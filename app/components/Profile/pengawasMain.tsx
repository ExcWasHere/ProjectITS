...
const profileList = [
  {
    id: 1,
    name: "Ir. Abdullah, M.Si",
    job: "Ketua Dewan Pengawas",
    image: "#",
  },
  {
    id: 2,
    name: "Dr. Ir. Soekartedjo, M.Si",
    job: "Anggota Dewan Pengawas",
    image: "#",
  },
  {
    id: 3,
    name: "Dr. Ir. Tontowi, M.Si",
    job: "Anggota Dewan Pengawas",
    image: "#",
  },
  {
    id: 4,
    name: "Prof. Ir. Achmad Baktir, M. APP",
    job: "Anggota Dewan Pengawas",
    image: "#",
  },
  {
    id: 5,
    name: "Ir. Murdijanto, M.Eng",
    job: "Anggota Dewan Pengawas",
    image: "#",
  },
  {
    id: 6,
    name: "Ir. Sudjud Darsopuspito, MT",
    job: "Anggota Dewan Pengawas",
    image: "#",
  },
];

export default function DewanPengawas(): JSX.Element {
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="text-center md:text-left max-w-2xl">
            ...
            <p className="mt-6 text-lg text-gray-600 leading-relaxed">
              Dewan Pengawas Yayasan Manarul Ilmi Institut Teknologi Sepuluh Nopember Periode 2025 - 2030.
            </p>
          </div>
